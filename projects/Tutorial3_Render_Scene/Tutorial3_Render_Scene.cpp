#include "Tutorial3_Render_Scene.h"
#include "Gizmos.h"
#include "Utilities.h"
#include <GL/glew.h>
...
Tutorial3_Render_Scene::Tutorial3_Render_Scene()
{
...
bool Tutorial3_Render_Scene::onCreate(int a_argc, char* a_argv[])
{
	...
	GLuint fshader = Utility::loadShader("../../bin/shaders/Tutorial2_FBX.frag", GL_FRAGMENT_SHADER);
...
void Tutorial3_Render_Scene::onUpdate(float a_deltaTime)
{
...
void Tutorial3_Render_Scene::onDraw()
{
...
void Tutorial3_Render_Scene::onDestroy()
{
...
int main(int argc, char* argv[])
{
	...
	Application* app = new Tutorial3_Render_Scene();

	if (app->create("AIE - Tutorial3_Render_Scene", DEFAULT_SCREENWIDTH, DEFAULT_SCREENHEIGHT, argc, argv) == true)
		app->run();
...
void Tutorial3_Render_Scene::InitFBXSceneResource(FBXFile *a_pScene)
{
...
void Tutorial3_Render_Scene::DestroyFBXSceneResource(FBXFile *a_pScene)
{
	// how many meshes and materials are stored within the fbx file
	unsigned int meshCount = a_pScene->getMeshCount();
	unsigned int matCount = a_pScene->getMaterialCount();
...
void Tutorial3_Render_Scene::UpdateFBXSceneResource(FBXFile *a_pScene)
{
	a_pScene->getRoot()->updateGlobalTransform();
}

void Tutorial3_Render_Scene::RenderFBXSceneResource(FBXFile *a_pScene, glm::mat4 a_view, glm::mat4 a_projection)
{
	// activate a shader
